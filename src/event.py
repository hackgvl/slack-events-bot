        ...
        return [
            {
                ...
                "text":  {
                    "type": "plain_text",
                    "text": truncate_string(self.title)
                }
            },
            {
                "type": "section",
...
def parse_location(event_json):
    ...
    if None not in (event_json['venue']['name'],
                    event_json['venue']['address'], event_json['venue']['city'],
                    event_json['venue']['state'], event_json['venue']['zip']):
        return (f"{event_json['venue']['name']} at "
...
def print_datetime(time):
    ...
    return time.astimezone(pytz.timezone(os.environ.get("TZ"))
